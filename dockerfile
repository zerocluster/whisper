...
RUN \
    ...
    \
    # patch nodejs addon
    && curl -fsSL https://raw.githubusercontent.com/zerocluster/whisper/main/addon/addon.cpp -o examples/addon.node/addon.cpp \
    && curl -fsSL https://raw.githubusercontent.com/zerocluster/whisper/main/addon/CMakeLists.txt -o examples/addon.node/CMakeLists.txt \
    \
